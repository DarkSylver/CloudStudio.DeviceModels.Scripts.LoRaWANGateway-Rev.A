...
# Configuration Script – LoRaWAN Gateway - Rev. A

This **Configuration** script is designed for the **LoRaWAN Gateway** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – LoRaWAN Gateway Rev. A

Este script de **Configuration** está diseñado para el modelo **LoRaWAN Gateway** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
